...
import { TURNBACKCYLINDERTOWAREHOUSEEMPTY } from 'config';
import getUserCookies from "getUserCookies";
import Constant from "Constants";

async function turnBackCyLinderToWareHouseEmptyAPI(driver, license_plate, cylinders, type, to_id, import_type, numberOfCylinder,
    ...
    if (user_cookies) {
        ...
        await axios.post(
            TURNBACKCYLINDERTOWAREHOUSEEMPTY, params, {
            headers: {
...
export default turnBackCyLinderToWareHouseEmptyAPI;

...
class SeeInforItem extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps && nextProps.itemGas && (JSON.stringify(nextProps.itemGas) !== JSON.stringify(this.props.itemGas))) {
      this.setState({
              ...
              <Col className="modal-body">
                ...
                >
                  ...
                  <Row>
                    ...
                    <Col xs={24} md={10}>
                      <div className="form-group">
                        <label for="">{this.props.t('Chỉ tiêu chất lượng chủ yếu')}</label>
                        <br></br>
                        {/* <select
                          class="form-control"

...
class FormWarehouseFull extends React.Component {
  constructor(props) {
    super(props);
    this.form = null;
    this.state = {
  ...
  async submit(event) {
    ...
    if(this.props.isCreateMode){
        ...
        if(doubleCode){
          ...
          const modal = $("#create-warehouse-full");
                      modal.modal("hide");
        }else{
  ...
  render() {
    ...
    let { nameware,codeware,listWares,userType} = this.state;
    console.log(listWares,userType)
    return (
      
      <div className="modal fade" id="create-warehouse-full" tabIndex="-1">
...
export default withNamespaces()(FormWarehouseFull);

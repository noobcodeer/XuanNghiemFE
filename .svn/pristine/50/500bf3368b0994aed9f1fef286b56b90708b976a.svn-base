                    ...
                    <div className="card-title">
                        <div className="flexbox">
                            ...
                            <div className="row">
                                ...
                                <button onClick={this.addUser} style={{ backgroundColor :"#ED383C", marginLeft: '20px' }} className="btn btn-sm btn-create" data-toggle="modal"
                                    data-target="#create-user"> {this.props.t('CREATE_CAR')}
                                </button>
                                ...
                                <div className="row">
                                    <div className="col-sm-12">
                                        <table
                                            ...
                                            <tbody>
                                                {console.log("INFOR",this.state.listUsers)}

                ...
                <div className="card">
                    <div className="card-title">
                        <div className="flexbox">
                            <h4 style={{ marginRight: 0 }}>{this.props.t('INDUSTRIAL_CUSTOMERS')}</h4>
                                        ...
                                        >
                                            <thead className="table__head">
                                                <tr>
                                                    ...
                                                    <th className="w-120px text-center align-middle">{this.props.t('AREA')}</th>
                                                    <th className="w-100px text-center align-middle">{this.props.t('ACTION')}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                {this.state.listUsers.map((store, index) => {
                                                    // console.log("avbuyasvbyfbv", store);
                                                    if(index >= this.state.minIndex && index < this.state.maxIndex )
                                                    return (
                                                        <tr key={index}>
                                                            ...
                                                            <td scope="row" className="text-center">
                                                                {(store.area !== null) ? store.area.name : "NULL"}
                                                                {/* {
                                                                    store.groupCustomer === 'mongcai'
                                                                        ? this.props.t('AREA_MONG_CAI')
                                                                        : store.groupCustomer === 'vandon'
                                                                            ? this.props.t('AREA_VAN_DON')
                                                                            : store.groupCustomer === 'campha'
                                                                                ? this.props.t('AREA_CAM_PHA')

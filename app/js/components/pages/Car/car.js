                    ...
                    <div className="card-title">
                        <div className="flexbox">
                            ...
                            <div className="row">
                                ...
                                <button onClick={this.addUser} style={{ backgroundColor:"#ED383C", marginLeft: '20px' }}
                                        ...
                                        <table className="table table-striped table-bordered seednet-table-keep-column-width"
                                            ...
                                            className="table__head">
                                                <tr>
                                                    ...
                                                    <th className="text-center w-70px">{this.props.t('EMAIL')}</th>

...
class AddManufacturerPopup extends React.Component {
  ...
  async submit(event) {
    ...
    console.log("notInsystem: ", this.state.notInSystem);
    if (res) {
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <div className="form-group">
                        <label className="mr-2">Bình Tạp</label>
                        <input type="checkbox" name="binhtap" 
                        value={this.state.notInSystem} 
                        onClick={() => this.setState({notInSystem: !this.state.notInSystem})} />
                      </div>
                      <div className="form-group">
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="form-group">
                        ...
                        <label className="d-block">{this.props.t("Chỉ tiêu chất lượng chủ yếu")}</label>
                        {/* <Select
                          className="form-control"

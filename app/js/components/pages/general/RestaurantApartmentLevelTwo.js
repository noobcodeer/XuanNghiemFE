...
class RestaurantLevelTwo extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            listUsers: [],
    ...
    handleButtonListExcel = async () => {
        let user_cookies = await getUserCookies();
        let id = user_cookies.user.id;
        let customerType = "Level_2_Agency";
                ...
                <div className="card">
                    <div className="card-title">
                        <div className="flexbox">
                            <h4>{this.props.t("RESTAURANT_LEVEL_TWO")}</h4>
                            ...
                            <div className="row">
                                ...
                                >
                                    {this.props.t("CREATE_APARTMENT_LEVEL_TWO")}
                                </button>
                                        ...
                                        >
                                            <thead className="table__head">
                                                <tr>
                                                    ...
                                                    <th className="w-150px text-center align-middle">{this.props.t("APARTMENT_LEVEL_TWO_NAME")}</th>
...
export default withNamespaces()(RestaurantLevelTwo) ;
...
class AddUserPopupContainer extends React.Component {
    ...
    async addCustomer(name, email, invoiceName, invoiceAddress, customerType, customerCode, userType, userRole, createdBy, isChildOf, listAgency, LAT, LNG, groupCustomer,area) {
    ...
    async updateUser(id, name, password, address, warehouseCode, customerCode, invoiceAddress, groupCustomer, lat, lng, agencyCode,invoiceName, area) {
        ...
        // Update user
        this.setState({ isLoading: true });
        const user = await updateUserAPI(id, name, password, address, warehouseCode, customerCode, invoiceAddress, groupCustomer, lat, lng, agencyCode,invoiceName, area);
        this.setState({ isLoading: false });
        //console.log('register',user);
        if (user) {
    ...
    render() {
        return (
            <AddUserPopup
                ...
                isRestaurantLevelTwoPage={this.props.isRestaurantLevelTwoPage}

            ...
            <Form ref={c => this.form = c} className="form-type-material">
                ...
                <div className="form-group">
                    <label  style={{ fontWeight: "bold" }}
                     htmlFor="email"> {this.props.t("EMAIL_ADDRESS")}
                    </label>
                    <br/>
                    <Input                 
                        type="text"
                ...
                <div className="form-group">
                    <label style={{ fontWeight: "bold" }}
                    htmlFor="password"> {this.props.t("PASSWORD")}
                    </label>
                    <br/>
                    <Input
                        name="password"
                ...
                <div className="form-group flexbox">
                    <div className="custom-control custom-checkbox">
                        ...
                        className="custom-control-label"> {this.props.t("REMEMBER")}
                        </label>
                    </div>
                ...
                <div  className="form-group">
                    ...
                    className="btn btn-bold btn-block btn-pink" 

...
import FormWarehouseFull from './FormWarehouseFull';

class ProductWareHouse extends React.Component {
    ...
    render() {
        return (
            <div className="main-content">
                ...
                <FormWarehouseFull isCreateMode={this.state.isCreateMode}
...
export default withNamespaces()(ProductWareHouse);
